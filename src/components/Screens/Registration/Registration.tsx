...
const USER_REGEX = /^[a-zа-яA-ZА-Я][a-zа-яA-ZА-Я0-9-_]{2,23}$/;
...
const Registration: React.FC = (props) => {
   ...
   const handlerSubmit = async (e: React.ChangeEvent<any>) => {
      ...
      try {
         ...
         const register = await new AuthenticationService().register(
            registerRequest
         );
         if (register == true) {
            setSuccess(true);
         ...
         if (register) {
            window.location.href = FRONTEND_URL + `/auth/authorization`;
         }
      } catch (err) {
         setErrorMessage("Ошибка регистрации");
         ...
         <section>
            <div className="registration">
               ...
               <div className="registration__body">
                  ...
                  <form onSubmit={handlerSubmit} className="registration__form">
                     <div>
                     ...
                     Должны содержать заглавные и строчные буквы, цифру и специальные символы (! @ # $ %)"
                        placeholder="Пароль"
